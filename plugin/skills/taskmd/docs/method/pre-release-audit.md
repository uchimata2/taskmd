...
**Requested, never automatic, and never a step in the release procedure.** An audit of everything
costs several working sessions. Wired into every release it becomes a cost the release cannot refuse,
and a cost that cannot be refused is one that gets skipped — quietly, and first under time pressure.
Keep it outside the sequence and ask for it when the release is worth it.
