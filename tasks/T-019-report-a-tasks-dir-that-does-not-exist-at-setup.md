...
- [ ] Shown failing per R-16, on all three cases above — typo'd value, absent folder,
      ...
      per [`review`](../plugin/skills/taskmd/docs/method/review.md) — the original text is the record, the amendment is
