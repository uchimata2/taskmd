...
- In: the mechanism that makes [`docs/METHOD.md`](../plugin/skills/taskmd/docs/METHOD.md) §3.1–§3.3 fire, and what the
...
**Inputs**
- [`docs/METHOD.md`](../plugin/skills/taskmd/docs/METHOD.md) §3 and §7 — the rules the skill must make fire, and the
  tier-3 files it hands over to.
- [`docs/SCOPE.md`](../docs/SCOPE.md) R-6…R-9, R-21, R-22, and §1 *Invisibility*.
- [`docs/BINDING.md`](../plugin/skills/taskmd/docs/BINDING.md) §1 and
  [`docs/bindings/local-markdown.md`](../plugin/skills/taskmd/docs/bindings/local-markdown.md) — the six operations, and
...
- [`tasks/_task-template.md`](_task-template.md) and
  [`taskmd/defaults/config.md`](../plugin/skills/taskmd/taskmd/defaults/config.md) — what a created task must carry for
  `check` to accept it.
...
They are **[`docs/METHOD.md`](../plugin/skills/taskmd/docs/METHOD.md) §3.1, §3.2 and §3.3** — serving R-6, R-7 and R-8
...
**D1 — Four tiers, and only one file is new.** description → body → [`docs/METHOD.md`](../plugin/skills/taskmd/docs/METHOD.md)
→ [`docs/method/<phase>.md`](../plugin/skills/taskmd/docs/method/). The method already had the last two and
...
| 2 | when the body points at it | [`docs/METHOD.md`](../plugin/skills/taskmd/docs/METHOD.md) | anything naming a file, a field or a command — it is backend-neutral by design |
| 3 | when a phase begins | [`docs/method/<phase>.md`](../plugin/skills/taskmd/docs/method/) | the spine's own rules |
| — | before a write | the project's binding | the vocabulary, which belongs to the project ([`docs/BINDING.md`](../plugin/skills/taskmd/docs/BINDING.md) §2) |
