...
| [T-244](T-244-audit-everything-0-6-0-ships-before-1-0-0-and-review-the-audit-method-while-using-it.md) | Audit everything 0.6.0 ships before 1.0.0, and review the audit method while using it | `M7` | `proposed` | `specify` | - | - | - | T-246 | T-152, T-223, T-231, T-243 |
...
| [T-146](T-146-decide-whether-a-field-can-be-required-at-a-status.md) | Decide whether a field can be required at a status | `M6` | `done` | `review` | - | - | - | - | T-065, T-089, T-100, T-106, T-173, T-184, T-245 |
...
| [T-223](T-223-ship-the-pre-release-audit-as-a-method-document.md) | Ship the pre-release audit as a method document, so every adopter gets it | `M6` | `done` | `review` | - | - | - | - | T-032, T-036, T-231, T-244 |
