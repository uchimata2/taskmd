...
| [T-212](T-212-report-a-closed-parent-that-still-has-an-open-child.md) | Report a closed parent that still has an open child | `M6` | `blocked` | `plan` | - | - | - | T-191, T-198, T-209, T-216, T-218 |
...
| [T-216](T-216-repair-the-three-closed-parents-that-still-have-an-open-child.md) | Repair the three closed parents that still have an open child | `M6` | `done` | `review` | - | - | T-212 | T-135, T-168, T-192, T-212, T-218 |
