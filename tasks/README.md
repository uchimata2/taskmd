...
| [T-241](T-241-verify-the-published-0-6-0-from-outside-and-record-what-cannot-be-reached.md) | Verify the published 0.6.0 from outside, and record what cannot be reached | `M6` | `proposed` | `specify` | - | - | - | T-085, T-231 |
...
| [T-182](T-182-write-the-next-release-note-to-the-rule-and-say-what-it-caught.md) | Write the next release note to the rule and say what it caught | `M6` | `done` | `review` | - | - | - | T-125, T-127, T-133, T-135, T-230, T-231, T-242, T-243 |
...
| [T-231](T-231-cut-the-next-release.md) | Cut the next release | `M6` | `done` | `review` | - | - | T-241 | T-085, T-135, T-182, T-223, T-232, T-241, T-242, T-243 |
...
| [T-242](T-242-judge-adopter-visible-on-the-closed-m6-tasks-the-release-note-must-cover.md) | Judge adopter_visible on the closed M6 tasks the release note must cover | `M6` | `done` | `review` | - | - | - | T-135, T-182, T-231, T-243 |
