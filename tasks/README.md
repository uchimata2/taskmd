...
| [T-257](T-257-decide-what-a-deliverable-a-clone-never-receives-asserts.md) | Decide what a deliverable a clone never receives asserts, and get CI green | `M7` | `specified` | `specify` | - | - | - | - | T-089, T-090, T-103, T-250 |
...
| [T-103](T-103-say-whether-a-closed-task-s-declared-output-may-be-repointed.md) | Say whether a closed task's declared output may be repointed when the file moves | `M3` | `done` | `review` | - | - | - | - | T-053, T-076, T-083, T-089, T-090, T-092, T-104, T-109, T-257 |
