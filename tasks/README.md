...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| [T-003](T-003-write-the-skill-that-teaches-the-agent-to-use-the-cl.md) | Write the skill that teaches the agent to use the CLI | - | `proposed` | `specify` | - | - | T-002, T-008 | T-006 | T-008, T-017, T-019, T-021, T-022, T-026 |
...
| [T-006](T-006-package-document-and-publish.md) | Package, document and publish | - | `proposed` | `specify` | - | - | T-002, T-003, T-008, T-009, T-010, T-011, T-018 | - | T-004, T-013, T-019, T-020, T-023, T-026 |
...
| [T-026](T-026-audit-the-whole-project-before-the-remaining-build.md) | Audit the whole project before the remaining build | - | `proposed` | `specify` | - | - | - | - | T-003, T-006, T-010, T-025 |
...
| [T-002](T-002-implement-the-core-cli-context-index-check.md) | Implement the core CLI: context, index, check | - | `done` | `review` | - | T-019, T-020, T-021 | T-001 | T-003, T-006, T-011 | T-004, T-005, T-007, T-008, T-025 |
...
| [T-018](T-018-stop-the-pre-publish-fixture-tripping-its-own-check.md) | Stop the pre-publish fixture tripping its own check | - | `done` | `review` | - | - | - | T-006 | T-013 |
...
| [T-022](T-022-filtered-task-listing-for-scripts.md) | Filtered task listing for scripts | - | `done` | `review` | - | - | - | - | T-003, T-007, T-021 |
