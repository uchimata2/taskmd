...
([`../docs/METHOD.md`](../docs/METHOD.md) §4) — a dependency edge here would falsely say the audit
cannot proceed.
...
[`audit.md`](../docs/method/audit.md) makes them worth as much as the rest; splitting them off is how
they get skipped.
...
clean" from "not looked at" ([`audit.md`](../docs/method/audit.md)).
...
good at ([`review`](../docs/method/review.md) step 1).
...
declined as out of this phase's remit ([`review`](../docs/method/review.md) — *not an audit*): that
