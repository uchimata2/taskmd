...
| :--- | :--- | :--- |
| 2026-08-22 | (no change) | **The owner's answer: §4's recommendation stands, and criterion 2 is met as recorded.** Asked in the batched round of 2026-08-22 — the criterion is met under the reading §4 took (*the count of cases [T-198](T-198-show-each-quiet-fixture-is-within-its-own-check-s-reach.md) names that this reading does not hold*) and not met under the absolute-total reading, and choosing between them was flagged there as the owner's. **Answered: recommendation accepted**, so the absolute-total reading is not adopted. The owner had the row above when answering — that one of the recommendation's two grounds expired when T-198 closed, leaving the stronger one standing, and that [T-215](T-215-show-a-paired-fixture-s-quiet-case-is-in-reach-or-record-that-it-cannot-be.md) recorded the `planned-deliverable` case as **permanently** unmarkable. §4 is annotated rather than edited (METHOD rule 5): the verdict is what it was, and what this row adds is that it was put to the owner and upheld. Nothing here re-opens the record. |
| 2026-08-22 | (no change) | **One of the reasons behind §4's criterion-2 recommendation expired the same day, and the question is still the owner's.** That row rejects the *absolute total* reading on two grounds: a hand-written total is a derived value that decays, **and** [T-198](T-198-show-each-quiet-fixture-is-within-its-own-check-s-reach.md) is still open so its record can still move. **T-198 closed on 2026-08-22**, so the second ground no longer holds; the first is unaffected and is the stronger of the two. [T-215](T-215-show-a-paired-fixture-s-quiet-case-is-in-reach-or-record-that-it-cannot-be.md), which carried criterion 1's live gap, also closed that day and recorded the `planned-deliverable` case as **permanently** unmarkable rather than as a residual — which is a fact the owner should have when choosing between the two readings. §4 is annotated here rather than edited (METHOD rule 5): the verdict is what it was, and what changed is the world around one of its reasons. Nothing about this blocks anything. |
