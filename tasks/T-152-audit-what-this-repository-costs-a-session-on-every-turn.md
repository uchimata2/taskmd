...
| [E-08](../docs/audits/2026-08-15-context-economy-portable.md#e-08) | Screen a figure on its source and on where the effect concentrates | low | none | A rule for the audit **method**, which is another repository's. **The rule is in that repository** — under a heading of its own in `references/measure.md`, in the method's own words and carrying the same benchmarked example the finding was drawn from. Nothing was sent from here, and no route was ever shown, so the outcome is right and the reason was not. *Until 2026-08-19 this cell ended “Carried in the portable deliverable, which is the handover”. [T-189](T-189-say-whether-the-audit-s-method-finding-reached-the-repository-that-owns-it.md) read the owning repository, found the rule already there, and corrected the outcome; the reason stays refuted, exactly as [T-170](T-170-decide-whether-the-audit-s-upstream-rows-are-reported-to-anyone.md) refuted it for U-01/U-02 four rows below.* |
