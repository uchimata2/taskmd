...
**The destination still exists.** `uchimata2/taskmd-migration-proof` is private and disposable, and
deleting it is the maintainer's — this task will not destroy the evidence it just produced.
