...
**Outputs produced**
- [`taskmd/schema.py`](../taskmd/schema.py) — symmetric derivation, `Task.links()`, self-link guard
- [`taskmd/defaults/config.md`](../taskmd/defaults/config.md) — the `soft` row and its explanation
